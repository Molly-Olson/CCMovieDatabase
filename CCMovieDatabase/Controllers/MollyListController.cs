...
{
    public class MollyListController : Controller
    {
        private readonly MovieContext _context;

        public MollyListController(MovieContext context)
        {
            _context = context;
        }
